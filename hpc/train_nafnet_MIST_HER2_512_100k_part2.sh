#!/bin/bash
#SBATCH --job-name=nafnet_MIST_HER2_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_HER2_512_100k_p2_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_HER2_512_100k_p2_%j.err
...
srun apptainer exec \
    ...
    options/train/MIST/NAFNet-MIST-HER2-512-100k-part2.yml
    "

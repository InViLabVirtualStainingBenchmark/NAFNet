#!/bin/bash
#SBATCH --job-name=nafnet_MIST_PR
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/nafnet_MIST_PR"
...
srun apptainer exec \
    ...
    -B "$OUTPUT_DIR":/output \
    "$CONTAINER" \
    bash /code/NAFNet/train_nafnet.sh options/train/MIST/NAFNet-width64-PR.yml

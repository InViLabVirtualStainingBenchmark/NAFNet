#!/bin/bash
#SBATCH --job-name=eval_nafnet_BCI_512
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -A ap_invilab
#SBATCH -p broadwell
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/eval_nafnet_BCI_512_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/eval_nafnet_BCI_512_%j.err
set -euo pipefail
...
srun apptainer exec \
    ...
    "$CONTAINER" python3 /evaluate/evaluate.py \
        --pred   /grp/transformer_prediction/NAFNet_BCI_512 \
        --gt     /data/test/IHC \
        --model_name   NAFNet_512 \
        --dataset_name BCI \
        --split_name   test \
        --match_by     stem \

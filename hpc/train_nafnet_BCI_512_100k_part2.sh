#!/bin/bash
#SBATCH --job-name=nafnet_BCI_512_100k_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p2_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p2_%j.err
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/nafnet_BCI_512_100k"
...
# Copy part1 final checkpoint for part2 resume
cp $VSC_DATA/projects/code/NAFNet/experiments/NAFNet-BCI-512-100k-part1/models/net_g_latest.pth    $VSC_DATA/projects/outputs/nafnet_BCI_512_100k/checkpoints/net_g_45000.pth
...
srun apptainer exec \
    ...
    options/train/BCI/NAFNet-BCI-512-100k-part2.yml
    "

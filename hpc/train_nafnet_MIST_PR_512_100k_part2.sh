#!/bin/bash
#SBATCH --job-name=nafnet_MIST_PR_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_PR_512_100k_p2_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_PR_512_100k_p2_%j.err
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/nafnet_MIST_PR_512_100k"
...
srun apptainer exec \
    ...
    options/train/MIST/NAFNet-MIST-PR-512-100k-part2.yml
    "

#!/bin/bash
#SBATCH --job-name=nafnet_MIST_PR_512_p1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_PR_512_100k_p1_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_MIST_PR_512_100k_p1_%j.err
...
srun apptainer exec \
    ...
    options/train/MIST/NAFNet-MIST-PR-512-100k-part1.yml
    "

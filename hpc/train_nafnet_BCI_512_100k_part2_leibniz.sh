#!/bin/bash
#SBATCH --job-name=nafnet_BCI_512_100k_p2_leib
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p2_leib_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p2_leib_%j.err
set -euo pipefail
...
GPU_LOG_PID=$!
cp $VSC_DATA/projects/code/NAFNet/experiments/NAFNet-BCI-512-100k-part1/models/net_g_latest.pth \
   $VSC_DATA/projects/outputs/nafnet_BCI_512_100k_leibniz/checkpoints/net_g_45000.pth
srun apptainer exec \
    --nv \
    -B "$CODE_DIR":/code \

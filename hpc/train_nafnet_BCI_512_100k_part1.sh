#!/bin/bash
#SBATCH --job-name=nafnet_BCI_512_100k_p1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p1_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/nafnet_BCI_512_100k_p1_%j.err
